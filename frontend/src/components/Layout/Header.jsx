...
const Header = () => {
  ...
  return (
    <nav className="border-b border-gray-300 shadow-md">
      <div className=" max-w-full mx-auto px-4 pt-2 flex justify-between items-center  ">
        <div className="flex items-center">
          <img src={logo} alt="Logo" className="h-14 mx-6" />
        ...
        <div className="flex items-center ">
          <div className="flex items-center space-x-8">
            ...
            <div>
              <IN title="United States" className="h-6 rounded-sm" />
            </div>
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <Link to="/account" className="ml-8 mr-2">
